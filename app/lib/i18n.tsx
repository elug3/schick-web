...
const dictionaries: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    "home.heroFeatured": "Editor's Pick",
    ...
    "product.relatedSubtitle": "Curated for you",
    "product.signInToWishlist": "Sign in to save items to your wishlist",
  ...
  ko: {
    ...
    "product.style": "스타일",
    "product.family": "대상",
    "product.productType": "유형",
    "product.relatedTitle": "추천 상품",
    "product.relatedSubtitle": "함께 보면 좋은 가방",
    "product.signInToWishlist": "위시리스트에 저장하려면 로그인하세요",
  ...
  zh: {
    ...
    "product.relatedTitle": "猜你喜欢",
    "product.relatedSubtitle": "为您精选",
    "product.signInToWishlist": "登录后将商品保存到愿望清单",
